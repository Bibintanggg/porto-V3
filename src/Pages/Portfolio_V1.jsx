...
const portfolioInfo = {
  id: 2,
  title: "Portfolio V1",
  desc: "This is my very first project in the programming world. I built this website from scratch as a way to apply what I’ve learned so far. It may still be simple, but it represents my journey, efforts, and the beginning of my growth as a developer. I’m excited to keep learning and improving from here!",
  image: Porto,
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 mt-4 gap-2 w-full md:w-[29rem]">
                    {portfolioInfo.tech_used.map((text, index) => (
                      ...
                      >
                        <img
                          src={portfolioInfo.tech_icon[index]}
                          alt=""
                          className="w-6"
                        />
                  ...
                  >
                    ...
                    >
                      <div className="flex gap-3 items-center mb-4">
                        ...
                        />
                        <p className="font-jakarta font-semibold">Feature</p>
                      </div>
