      ...
      <div className="ml-[250px] w-full overflow-y-auto">
        <div className="bg-transparent p-8">
          ...
          <div className=" flex justify-between items-center">
            ...
            <div>
              <img src={sleepWellProject.image} alt="" className="w-[30rem]" />
            </div>
          </div>
          ...
          <div className="mt-6 flex gap-10">
            {sleepWellProject.demo_text.map((text, index) => (
              <button
                key={index}
                className="flex items-center gap-2 mb-2 bg-white w-32 h-10 rounded-lg justify-center"
              >
                <img
          ...
          <div className="mt-3">
            ...
            <div className="grid grid-cols-3 mt-4 gap-5 w-[30rem]">
              {sleepWellProject.tech_used.map((text, index) => (
                <div
                  key={index}
                  className="flex gap-3 items-center bg-white w-36 h-10 rounded-lg justify-center"
                >
                  <img
