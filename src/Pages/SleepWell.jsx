...
const valueProject = [
  ...
  {
    id: 2,
    title: "Sleep Health Articles",
  },
  {
    id: 3,
    title: "Fairy Tales Online",
  },
  {
    id: 4,
...
const sleepWellProject = {
  id: 1,
  title: "Sleep Health Website",
  desc: "An educational platform that aims to raise awareness of the importance of healthy sleep, especially for those suffering from insomnia and sleep disorders. Created as a project in a bootcamp for exploring web development.",
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 mt-4 gap-2 w-full md:w-[29rem]">
                    {sleepWellProject.tech_used.map((text, index) => (
                      ...
                      >
                        <img
                          src={sleepWellProject.tech_icon[index]}
                          alt=""
                          className="w-6"
                        />
