        ...
        <div className="bg-transparent p-8">
          ...
          <div className="flex flex-col items-center h-auto gap-5 p-10">
            <div className="flex items-center gap-5">
              <div
                className={`w-[60rem] h-[19rem] items-center mx-auto isolate aspect-video 
              ...
              >
                ...
                <div className="px-16">
                  <div className="flex items-start gap-32">
                    ...
                    <div className="pt-3">
                      <p
                        className={`max-w-lg tracking-wide text-sm ${
                          darkMode ? "text-white" : "text-black"
                        }`}
                      >
                      ...
                      <p
                        className={`max-w-lg tracking-wide mt-5 text-sm ${
                          darkMode ? "text-white" : "text-black"
                        }`}
                      >
            ...
            <div
              className={`w-[60rem] h-48 mt-10  flex gap-10 items-center justify-center
            ...
            >
              {dataProject.map((project) => (
                <div
                  key={project.id}
                  className={`p-4 rounded-lg h-36 w-[17rem] 
