...
const money = {
  id: 4,
  title: "Money Track",
    desc: "MoneyTrack adalah proyek pribadi saya yang dirancang untuk mempermudah pengelolaan keuangan secara efisien. Dengan fitur pencatatan pemasukan dan pengeluaran yang terstruktur, MoneyTrack membantu pengguna mengontrol finansial mereka dengan lebih baik.",
  image: MoneyTrackIMG,
                                        ...
                                        {money.tech_used.map((text, index) => (
                                            <div
                                                ...
                                                className={`flex gap-3 items-center h-10 rounded-lg justify-center
                                                    ${darkMode ? 'bg-gradient-to-r from-black/50 to-black/30' : 'bg-white'}`}
                                            >
                                                <img src={money.tech_icon[index]} alt="" className="w-6" />
