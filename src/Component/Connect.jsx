    ...
    <div className=" flex justify-center font-poppins">
      ...
      >
        <div className="p-10">
          ...
          .
          <button className="mt-4 flex items-center" onClick={link}>
            <div
            ...
            >
              <div
                ...
                isolate aspect-video bg-white/20 shadow-lg ${
                  darkMode ? "bg-gray-600" : "bg-white"
                }`}
              >
                <img src={platforms[0].icon} className="w-6 h-6" />
              </div>
              <div className="ml-4">
